...
const GooeyNav: React.FC<GooeyNavProps> = ({
  ...
  // Sync active index with pathname on mount and navigation
  useEffect(() => {
        ...
        <nav className="flex relative" style={{ transform: 'translate3d(0,0,0.01px)' }}>
          ...
          >
            {items.map((item, index) => (
              <li
                key={index}
                className={`gooey-item rounded-full relative cursor-pointer transition-[background-color_color_box-shadow] duration-300 ease shadow-[0_0_0.5px_1.5px_transparent] text-white ${
              ...
              >
                <Link
                  ...
                  className="outline-none py-[0.5em] px-[0.8em] inline-block text-xs font-semibold uppercase tracking-wider"
                >
                  {item.label}
                </Link>
              </li>
